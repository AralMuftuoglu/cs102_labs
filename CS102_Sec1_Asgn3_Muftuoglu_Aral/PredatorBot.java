public class PredatorBot extends Robot
{
    public PredatorBot()
    {
        ...
        super.attack= (Math.random() * 1)+2;
        super.speed= (Math.random() * 0.5)+0.5;
        super.name="PredatorBot";
        super.robotId=numberOfRobots;
        super.code="P"+super.robotId;
        numberOfRobots++;
    ...
    public void attack(Simulation s)
    {
        ...
        if(super.isReadTeam)
        {
            index=s.blueTeam.indexOf(s.getHighestHealth(isReadTeam));
        }
        else
        {
            index=s.redTeam.indexOf(s.getHighestHealth(isReadTeam));
        }
